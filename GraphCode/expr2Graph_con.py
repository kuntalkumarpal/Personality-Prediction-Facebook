...
wo = [0.7299,0.7317,	0.7033,	0.7166]
w = [0.7182, 0.7042,	0.6944,	0.7077] #first value to change
...
ax1.set(title='Conscientiousness', ylabel='MSE')
ax1.legend()
#ax1.grid()
plt.ylim((0,1.05))
plt.xlim((0,3))
...
plt.savefig('10_Conscientiousness.eps', bbox_inches='tight')
